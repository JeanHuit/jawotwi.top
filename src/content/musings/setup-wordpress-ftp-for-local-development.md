...
draft: false
description: "Simple solution to setup FTP for WordPress local development."
author: "Jean Huit"
category: "Web Development"
tags: ["wordpress", "ftp", "local development", "web development", "configuration"]
keywords: ["wordpress", "ftp", "local development", "web development", "configuration"]
excerpt: "Ever encountered the issue of setting up an FTP server to allow you upload, update themes and plugins on your local/development version of wordpress?"
---
