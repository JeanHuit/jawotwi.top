...
draft: false
description: "A tutorial on setting up free hosting with continuous integration using Github, Codeship, and Firebase."
author: "Jean Huit"
category: "Development"
tags: ["github", "codeship", "firebase", "hosting", "continuous integration", "ci/cd"]
keywords: ["github", "codeship", "firebase", "hosting", "continuous integration", "ci/cd"]
excerpt: "If `free` is a requirement to hosting your code amidst running a continuous integration and delivery setup."
---

If `free` is a requirement to hosting your code amidst running a continuous integration and delivery setup.
<!--more-->
