...
draft: false
description: "Documenting the process of setting up DSpace, an open source repository software."
author: "Jean Huit"
category: "Development"
tags: ["dspace", "repository", "installation", "open source", "digital archive"]
keywords: ["dspace", "repository", "installation", "open source", "digital archive"]
excerpt: "I have spent over three weeks in trying to get dspace set up."
---
I have spent over three weeks in trying to get dspace set up.
<!--more-->

 It has been one helluva ride. Finally got it working somewhat on a windows OS and wanted to document the process for posterity sake.
