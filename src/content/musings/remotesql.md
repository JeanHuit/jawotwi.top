...
draft: false
description: "Guide to making MySQL accessible remotely on Ubuntu Server 20.04."
author: "Jean Huit"
category: "Database"
tags: ["mysql", "database", "remote access", "ubuntu", "server"]
keywords: ["mysql", "database", "remote access", "ubuntu", "server"]
excerpt: "Os: Ubuntu Server 20.04 If you ever find yourself unable to log-in or connect to your newly created MySQL server, with errors such as these being thrown around,"
---
