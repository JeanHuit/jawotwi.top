...
draft: false
description: "Discovering a simple script for monitoring your server with a quick glance."
author: "Jean Huit"
category: "Server Management"
tags: ["server", "monitoring", "bash", "script", "linux"]
keywords: ["server", "monitoring", "bash", "script", "linux"]
excerpt: "Discovered a simple script that allows you to monitor your server in a quick glance."
---
