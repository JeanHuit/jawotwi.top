...
draft: false
description: "A guide to using the grep command for searching text in Linux."
author: "Jean Huit"
category: "Linux"
tags: ["linux", "grep", "command line", "search", "terminal"]
keywords: ["linux", "grep", "command line", "search", "terminal"]
excerpt: "Another linux command, I find very useful,"
---
