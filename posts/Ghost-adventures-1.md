...
draft: false
description: "The first in the series telling of how Jean battled to get Ghost working on the OS X platform locally and on Github as static pages."
author: "Jean Huit"
category: "Blogging"
tags: ["ghost", "blogging", "open source", "os x", "github", "static pages", "installation"]
keywords: ["ghost", "blogging", "open source", "os x", "github", "static pages", "installation"]
excerpt: "These adventures follow Jean in his quest to get a blog up and running the open source way."
---
These adventures follow Jean in his quest to get a blog up and running the open source way.
<!--more-->
The first in the series,tell of how Jean battled to get Ghost working on the OS X platform locally and on Github as static pages.
