...
draft: false
description: "Steps to upload a WordPress site to a live server without relying on unreliable plugins."
author: "Jean Huit"
category: "Web Development"
tags: ["wordpress", "deployment", "web development", "hosting", "database"]
keywords: ["wordpress", "deployment", "web development", "hosting", "database"]
excerpt: "There are a thousand and one tutorials on the internet that teach how to go about this (title of post)."
---
